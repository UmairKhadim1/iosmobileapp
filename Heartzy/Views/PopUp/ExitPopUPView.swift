...
class ExitPopUPView: UIView {
    ...
    lazy var logoImg : UIImageView = {
        var img  = UIImageView()
        img.image = UIImage(named: "How_to_Exit")
    ...
    func setUp(){
        ...
        NSLayoutConstraint.activate([
            ...
            cancelBtn.heightAnchor.constraint(equalToConstant: 38 * appConstant.heightRatio),
            cancelBtn.widthAnchor.constraint(equalToConstant: 38 * appConstant.heightRatio),
