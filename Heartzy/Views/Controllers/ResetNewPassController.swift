...
//        view.layer.maskedCorners = [.layerMinXMaxYCorner,.layerMaxXMaxYCorner]
    ...
    lazy var newPasstitlelbl : UILabel = {
        let lbl = UILabel()
        lbl.clipsToBounds = true
        lbl.textColor = UIColor(named: Colors.Primary_Color)
        lbl.textAlignment = .center
        lbl.font = regular(size: 32)
        lbl.text = "Enter New Passcode"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    func setUPUI()
    {
        ...
        view.addSubview(newPasstitlelbl)
        ...
        NSLayoutConstraint.activate([
            ...
            newPasstitlelbl.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 76 * appConstant.heightRatio),
            newPasstitlelbl.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20 * appConstant.widthRatio),
            newPasstitlelbl.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20 * appConstant.widthRatio),
        
            createPassdesclbl.topAnchor.constraint(equalTo: newPasstitlelbl.bottomAnchor, constant: 20 * appConstant.heightRatio),
    ...
    @objc func editingChanged(_ textField: SingleDigitField) {
        ...
        case fourthDigitField:
            ...
            let vc = ConfirmNewPasscodeController()
