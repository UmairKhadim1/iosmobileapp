//
//  ResetCurrentPassController.swift
//  Heartzy
//
...
class ResetCurrentPassController: UIViewController {
...
//        view.layer.maskedCorners = [.layerMinXMaxYCorner,.layerMaxXMaxYCorner]
    ...
    lazy var currentPasstitlelbl : UILabel = {
        let lbl = UILabel()
        lbl.clipsToBounds = true
        lbl.textColor = UIColor(named: Colors.Primary_Color)
        lbl.textAlignment = .center
        lbl.font = regular(size: 32)
        lbl.text = "Enter Current Passcode"
        lbl.numberOfLines = 0
        lbl.adjustsFontSizeToFitWidth = true
        lbl.sizeToFit()
        lbl.translatesAutoresizingMaskIntoConstraints = false
    ...
    func setUPUI()
    {
        ...
        view.addSubview(currentPasstitlelbl)
        ...
        NSLayoutConstraint.activate([
            ...
            currentPasstitlelbl.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 76 * appConstant.heightRatio),
            currentPasstitlelbl.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20 * appConstant.widthRatio),
            currentPasstitlelbl.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20 * appConstant.widthRatio),
        
            createPassdesclbl.topAnchor.constraint(equalTo: currentPasstitlelbl.bottomAnchor, constant: 20 * appConstant.heightRatio),
